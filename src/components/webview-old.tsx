...
export default function Webview(props: WebviewProps) {
    ...
    useEffect(() => {
        ...
        view.addEventListener('context-menu', () => {
            //@ts-ignore
            ref.current.openDevTools({ mode:'docked' });
        });
        view.setAttribute('plugins', '');
        view.setAttribute('allowpopups', '');
        view.setAttribute('webpreferences', 'nativeWindowOpen=yes, contextIsolation=yes, sandbox=yes');
